...
static int xdp_md_btf_struct_access(struct bpf_verifier_log *log,
...
static u32
xdp_md_convert_xdp_md_access(enum bpf_access_type type,
...
xdp_md_get_convert_ctx_access(struct bpf_verifier_log *log,
			       const struct btf *btf, u32 btf_id)
{
	...
	if (btf_id != xdp_md_btf_ids[0])
		return NULL;
	return xdp_md_convert_xdp_md_access;
}
...
const struct bpf_verifier_ops xdp_verifier_ops = {
	...
	.btf_struct_access	= xdp_md_btf_struct_access,
	.get_convert_ctx_access = xdp_md_get_convert_ctx_access,
};
